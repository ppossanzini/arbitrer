...
namespace Arbitrer
{
  ...
  public static class ArbitrerExtensions
  {
    ...
    public static ArbitrerOptions SetAsLocalRequest<T>(this ArbitrerOptions options, string queuePrefix = null, ILogger logger = null) where T : IBaseRequest
    {
    ...
    public static ArbitrerOptions SetAsRemoteRequest<T>(this ArbitrerOptions options, string queuePrefix = null, ILogger logger = null) where T : IBaseRequest
    {
